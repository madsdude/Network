## Opret templaten (Definition) Cisco CLI
...
### 2. Brug templaten på interfaces (Application) Når templaten er oprettet, skal den "knyttes" til de fysiske porte. Det gør du sådan her:
